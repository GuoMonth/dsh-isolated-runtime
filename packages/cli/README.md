# DSH Isolated Runtime — historical standalone source

This directory retains the 0.2.0-alpha.1 standalone implementation. Current Cell packages are built from `packages/cell-cli`; this README is not the current install or publication entry.
...
[AI installation guide](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/ai/local-run.md)
