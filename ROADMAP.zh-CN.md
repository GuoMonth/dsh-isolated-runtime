...
企业自托管是长期方向，当前按 alpha MVP 要求推进。优先完成管理员集群部署、标准 OIDC
个人授权、持久化 Cell 用户流程及 kind 复现。Helm 是计划中的首选入口，尚未交付。
范围、资源归属、暂缓事项和验收标准见 [alpha MVP](docs/alpha-mvp.zh-CN.md)。
以下历史里程碑记录已完成工作，不代表生产可用性认证。
