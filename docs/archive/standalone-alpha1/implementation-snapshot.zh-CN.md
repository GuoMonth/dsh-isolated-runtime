...
**产品阶段：快速迭代的 MVP。** 当前目标是多租户 OIDC + Cell，通过中立内部接口协作。固定验证版本，允许破坏性变更，不承诺历史兼容、升级或无感恢复；快速失败并提供 AI 可解读诊断。见[项目宪法](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/CONSTITUTION.md)及[当前 MVP 验收](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/alpha-mvp.zh-CN.md)。Helm 和全面安装矩阵不阻塞首条链路。
新版集群目标、基础设施前提与验证入口见 [Kubernetes alpha 基线](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/kubernetes-baseline.md)。

**已发布的本地安装 alpha：v0.2.0-alpha.1。**
从[本地安装](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/quickstart.zh-CN.md)开始，或把 [AI 安装手册](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/ai/local-run.md)
交给你的 AI 助手。npm 入口与 [GitHub Releases](https://github.com/GuoMonth/dsh-isolated-runtime/releases)
直接下载复用同一份不可变安装包和公共 GHCR 镜像。
发行边界见[发行与验收](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/distribution.md)。
...
profile 或 hostname。完整内容见[示例](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/config/samples/dsh_v1alpha1_cell.yaml)与
[生成的 CRD](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/config/crd/bases/dsh.isolated.io_cells.yaml)。
...
[兼容性记录](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/compat/dsh/README.zh-CN.md)解释了为什么 access seam 最终选择由
...
[namespace 契约](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/specs/namespace-contract.zh-CN.md)与
[指标契约](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/specs/metrics.zh-CN.md)。
...
- [架构](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/specs/architecture.zh-CN.md)
- [威胁模型](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/docs/specs/threat-model.zh-CN.md)
- [Roadmap](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/ROADMAP.zh-CN.md)
- [贡献指南](https://github.com/GuoMonth/dsh-isolated-runtime/blob/v0.2.0-alpha.1/CONTRIBUTING.zh-CN.md)
