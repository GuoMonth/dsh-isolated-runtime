...
固定版本集成实证及其限制记录于[共享回归报告](https://github.com/GuoMonth/dsh-multi-tenant/blob/4ba252765bccb41314c0bdc6b11bcf60cc0b33ef/docs/evidence/cell-regression-2026-09-20.md)。[Runtime PR #93](https://github.com/GuoMonth/dsh-isolated-runtime/pull/93) 的源码 sandbox 收缩仍是未发行候选，不改变 npm `0.3.0-alpha.1` 或其固定制品。
