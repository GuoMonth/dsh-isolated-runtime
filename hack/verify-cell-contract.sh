...
kubectl --kubeconfig "$kubeconfig" -n tenant-alice patch cell assistant --subresource=status --type=merge \
  -p '{"status":{"observedGeneration":1,"conditions":[{"type":"Ready","status":"True","reason":"ContractVerified","message":"contract fixture is ready","lastTransitionTime":"2026-01-01T00:00:00Z"}],"dshVersion":"0.1.3-alpha.1","imageDigest":"sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"}}'
test "$(kubectl --kubeconfig "$kubeconfig" -n tenant-alice get cell assistant -o jsonpath='{.status.dshVersion}')" = "0.1.3-alpha.1"
